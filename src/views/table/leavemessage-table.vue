<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.commidtyid" placeholder="CommodityId" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column label="CommodityID" width="120px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.comid }}</span>
        </template>
      </el-table-column>
      <el-table-column label="LeaveMessage Time" width="160px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.time }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Message" width="395px" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="150px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="CommodityID" prop="comid">
          <el-input v-model="temp.comid" />
        </el-form-item>
        <el-form-item label="LeaveMessage Time" prop="time">
...
<script>
import { fetchLeaveMessageList, updateMessage, deleteMessage } from '@/api/article'
...
export default {
  ...
  methods: {
    getList() {
      ...
      console.log('getList')
      fetchLeaveMessageList(this.listQuery).then(response => {
